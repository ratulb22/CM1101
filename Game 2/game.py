...
def print_inventory_items(items):
    ...
    for value in items:
        if value == items[-1]:
            my_string = my_string + value['name'] + '.\n'
            break
        my_string = my_string + value['name'] + ', '
    print('You have ' + my_string)
...
def print_menu(exits, room_items, inv_items):
    ...
    for item in room_items:
        print('TAKE ' + item['id'].upper() + ' to take ' +
              item['name'] + '.')
    for item in inv_items:
        print('DROP ' + item['id'].upper() + ' to drop your ' + item['name'] +
              '. ')
    print('\nYou are carrying this much: ' + str(round(mass, 2)) + 'kg')
...
def execute_drop(item_id):
    ...
    try:
        ...
        print('I dont\'t quite understand')
