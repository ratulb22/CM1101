...
def remove_spaces(text):
    ...
    """
    """
    lst_to_store_text = text.split()
    new_text = ' '.join(lst_to_store_text)
    return new_text
    """
    return text.strip()
...
def display_room(room):
    ...
    """
    name_of_room = room['name']
    description = room['description']
    print("")
    print(name_of_room.upper())
    print("")
    print(description)
    print("")
...
def move(exits, direction):
    ...
    >>> move(rooms["Reception"]["exits"], "south") == rooms["Admins"]["name"]
    True
    >>> move(rooms["Reception"]["exits"], "east") == rooms["Tutor"]["name"]
    True
    >>> move(rooms["Reception"]["exits"], "west") == rooms["Office"]["name"]
    False
    """
